...
#How many students prefer light coffee? Fore each type of cofee roast?
...
if preference not in coffee_preferences.key():
    coffee_preferences[preference] +=1
else:
    preference
